...
console.log(boardMember1.sayHi()); // Output: "Hi, my name is Alice. I am from New York, and I was trained in Law."

const boardMember2 = new BoardMember("Bob", "California", "Finance");
